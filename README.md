...
3. تأكد من تثبيت Node.js على نظامك.
4. قم بتثبيت المكتبات المطلوبة عن طريق تشغيل الأمر `npm install` في التيرمينال داخل مجلد المشروع.
5. أنشئ ملف `.env` في مجلد المشروع وأضف اسم المستخدم وكلمة المرور الخاصة بحسابك على إنستجرام بالصيغ التالية:
